...
export default function Home() {
  ...
  useEffect(() => {
    // Simulate typing welcome message
    setIsTyping(true);
    setTimeout(() => {
      setMessages([{ role: 'assistant', content: 'Hello! 👋 Welcome to Thryve Credit Solutions! How can I assist you today?' }]);
      setIsTyping(false);
    }, 1500);
  }, []);
    ...
    <div style={{
      ...
      <div ref={chatRef} style={{
        ...
        {messages.map((msg, idx) => (
          <div key={idx} style={{
            marginBottom: 8,
            backgroundColor: msg.role === 'user' ? '#e0f7fa' : '#fff',
            padding: 8,
            borderRadius: 6,
            maxWidth: '100%',
            wordWrap: 'break-word'
